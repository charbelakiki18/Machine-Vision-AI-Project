...
print("8- " + predict_signature('test_signatures/test_signature8.jpg')) #Authentic
...
def draw_signature(img, tried):
    ...
    #Set quadrants where the signature is unlikely to be located in to white
    #Set the top-left quadrant to white
    img[:height // 2, :width // 2] = np.ones_like(img[:height // 2, :width // 2]) * 255

    #Set the top-right quadrant to white
    img[:height // 2, width // 2:] = np.ones_like(img[:height // 2, width // 2:]) * 255

    #Set the bottom-left quadrant to white
    img[height // 2:, :width // 2] = np.ones_like(img[height // 2:, :width // 2]) * 255
...
#Read the base image and the smaller image
my_signature = cv2.imread('test_signatures/test_signature8.jpg')  # Replace with your smaller image path
